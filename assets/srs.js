...
(function () {
  ...
  // 「できた」なら、その場でもう一度出さずに日をまたぐ予定へ送る。
  // FSRS は初めて「できた」札の安定度を約 3.2 日と見ており、次に出すべき日は
  // すでにこの式が持っている。同じ日にもう一段はさむのは Anki 時代の名残で、
  // 効果のわりに「答えても答えても残りが減らない」感じだけが残る。
  // 段を残すのは「もう一度」を押したときだけ。
  var LEARN_STEPS = [10];         // 初めて覚えるとき（もう一度のときだけ通る）
